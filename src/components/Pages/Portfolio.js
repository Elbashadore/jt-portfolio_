  ...
  <div class = " fontLight container-fluid row p-0 m-0" id="work">
        ...
        <img src={tv2} class="card-img-top" alt="Picture of a webpage with a map at the top"></img>
            <div class="card-body">
              ...
              <a href="https://pwa-jate-2022.herokuapp.com/" class="btn backgroundRed mx-1">Deployed Site</a>
              <a href="https://github.com/Elbashadore/Just-some-text" class="btn backgroundTeal">Repository</a>
            </div>
          </div>
          ...
          <div class="cardBorder backgroundGrey card col-md-4">
            ...
            <div class="card-body">
              ...
              <a href="https://immense-ravine-97579.herokuapp.com/" class="btn backgroundRed mx-1">Deployed Site</a>
              <a href="https://github.com/ila0406/Travel-Trustees-2" class="btn backgroundTeal">Repository</a>
            </div>
          </div>
          ...
          <div class=" cardBorder backgroundGrey card col-sm-4">
            ...
            <div class="card-body">
              ...
              <a href="https://elbashadore.github.io/WeatherDashboard/" class="btn backgroundRed mx-1">Deployed Site</a>
              <a href="https://github.com/Elbashadore/WeatherDashboard" class="btn backgroundTeal">Repository</a>
            </div>
          </div>
          ...
          <div class="cardBorder backgroundGrey card col-md-4">
            ...
            <div class="card-body">
              ...
              <a href="https://elbashadore.github.io/password-generator/" class="btn backgroundRed mx-1">Deployed Site</a>
              <a href="https://github.com/Elbashadore/password-generator" class="btn backgroundTeal">Repository</a>
            </div>
          </div>
          ...
          <div class="cardBorder backgroundGrey card col-md-4">
            ...
            <div class="card-body">
              ...
              <a href="https://elbashadore.github.io/Day-Planner/" class="btn backgroundRed mx-1">Deployed Site</a>
              <a href="https://github.com/Elbashadore/Day-Planner" class="btn backgroundTeal">Repository</a>
            </div>
          </div>
